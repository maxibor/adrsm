...
metagenome.{1,2}.trimmed.fastq: metagenome.1.fastq metagenome.2.fastq
	AdapterRemoval --file1 metagenome.1.fastq --file2 metagenome.2.fastq --output1 metagenome.1.trimmed.fastq --output2 metagenome.2.trimmed.fastq

aligned.bam: metagenome.{1,2}.trimmed.fastq
	bowtie2 -x b_anthracis -1 metagenome.1.trimmed.fastq -2 metagenome.2.trimmed.fastq | samtools view -bS - | samtools sort - > aligned.bam
...
clean:
	rm -rf metagenome* aligned.bam tmp